...
public class FlipSwitch extends WidgetBase implements DragEventsHandler, ClickHandler, HasValueChangeHandlers<Boolean>,
		IsEditor<LeafValueEditor<Boolean>>, HasValue<Boolean> {
	...
	public FlipSwitch() {
		initWidget(_html);
		setStyleName(StyleNames.FlipSwitch);
	...
	public void setEnabled(boolean enabled) {
		...
		if (enabled) {
			removeStyleName(SubStyleNames.disabled);
		} else {
			addStyleName(SubStyleNames.disabled);
		}
		_enabled = enabled;
	}
