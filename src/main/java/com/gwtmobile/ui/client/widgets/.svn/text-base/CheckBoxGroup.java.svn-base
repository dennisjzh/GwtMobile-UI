...
public class CheckBoxGroup extends PanelBase 
    ...
    public CheckBoxGroup() {
        ...
        setStyleName(StyleNames.CheckBoxGroup);
		addStyleName(SubStyleNames.vertical);
    }
    ...
    public void setVertical(boolean vertical) {
    	if (vertical) {
    		addStyleName(SubStyleNames.vertical);
    		removeStyleName(SubStyleNames.horizontal);
    	}
    	else {
    		addStyleName(SubStyleNames.horizontal);
    		removeStyleName(SubStyleNames.vertical);
    	}
    }
	...
	public void onDragStart(DragEvent e) {
    	...
    	if (_pressed >= 0) {
    		...
    		item.addStyleName(SubStyleNames.pressed);
    	}
	}
