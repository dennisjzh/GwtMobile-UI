...
public class CommunicationPage extends Page {
	...
	private static CommunicationPageUiBinder uiBinder = GWT
			.create(CommunicationPageUiBinder.class);

	interface CommunicationPageUiBinder extends UiBinder<Widget, CommunicationPage> {
	}
